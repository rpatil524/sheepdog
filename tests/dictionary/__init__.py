...
class Dictionary(object):
    ...
    def __init__(self, root_dir):
        ...
        self.metaschema_path = self._metaschema_path
        self.definitions_paths = self._definitions_paths
...
SCHEMA_DIRECTORY = os.path.join(DIRECTORY, 'schemas')

dictionary = Dictionary(SCHEMA_DIRECTORY)
